...
text0	
		!by 31,18,232,233,233,233,233,233,233,234,32,32,32,32,32,32,32,32,32,32,32,32,32,32
		!by 31,224,156,225,159,226,227,228,158,229,230,31,231,"p","r","g","-","f","I","L","E","S",32,32,32,32,32
		!by 31,235,236,236,236,236,236,236,237,32,32,32,32,32,32,32,32,32,32,32,32,32,239,146
		!by 30,$00

text1
		!by 31,32,32,"H","A","V","E",32,"F","U","N",32,32,"C","A","S","S","Y","-","D","E",0
...
com_jmp		!by <com_load0, >com_load0, <com_load1, >com_load1
			...
			!by <com_load8, >com_load8

menu_load0	!text "cHUCKIE eGG 32K",0
com_load0	!text "W",$2B,$00,$01
			!text "http://www.chris-straessle.de/chuck.prg",0 

menu_load1	!text "xsHOOT 16K",0
com_load1	!text "W",$2C,$00,$01
			!text "http://www.chris-straessle.de/xshoot.prg",0 

menu_load2	!text "xhORDE 16K",0
com_load2	!text "W",$2C,$00,$01
			!text "http://www.chris-straessle.de/xhorde.prg",0 

menu_load3	!text "xsNAKE 16K",0
com_load3	!text "W",$2C,$00,$01
			!text "http://www.chris-straessle.de/xsnake.prg",0 

menu_load4	!text "hAT tRICK 16K",0
com_load4	!text "W",$2E,$00,$01
			!text "http://www.chris-straessle.de/hattrick.prg",0 

menu_load5	!text "dEMO dsr dUNNO 4K",0
com_load5	!text "W",$2B,$00,$01
			!text "http://www.chris-straessle.de/dunno.prg",0 

menu_load6	!text "dEMO pACMAN 8K",0
com_load6	!text "W",$2C,$00,$01
			!text "http://www.chris-straessle.de/pacman.prg",0 

menu_load7	!text "sid tHING ON sPR 8K",0
com_load7	!text "W",$2B,$00,$01
			!text "http://www.chris-straessle.de/thing.prg",0 

menu_load8	!text "sid mONTY ON THE 8K",0
com_load8	!text "W",$2B,$00,$01
			!text "http://www.chris-straessle.de/monty.prg",0 

*=$1800  		; include font table 2k 
!bin "code/PXLfont88665B-RF2.3-VC20wic01.bin"
